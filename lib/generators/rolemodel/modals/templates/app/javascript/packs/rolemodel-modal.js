  ...
  enableModalClose() {
    if (this.closeModalElement) {
      this.closeModalElement.addEventListener('click', (e) => {
        ...
        setTimeout(() => { this.modalBody.innerHTML = ''}, 1000)
      })
    }
  }

  displayError() {
    this.modalBody.innerHTML = '<div class="page-load__error"><span class="material-icons">error</span><p>Uh oh! Something broke. Try reloading...</p></div>'
  }
}
